...
insert  into `member_complain`(`id`,`member_id`,`member_mobile`,`member_name`,`complain_title`,`complain_message`,`complain_time`,`replay_status`,`replay_userid`,`replay_time`,`replay_message`,`review_status`,`review_userid`,`review_time`,`review_message`) values (1,2,'18952028230','gepp2010','建议1','1、投诉管理 \r\n投诉管理列表：序号、投诉标题、投诉人、投诉时间、回复状态、回复时间、回复人、审核状态、审核时间、审核人\r\n查询条件包括：用户姓名（支持模糊）、用户手机、回复状态（全部、是、否）、审核状态（全部、是、否）、投诉时间起、投诉时间止、审核时间起、审核时间止\r\n2、投诉管理-回复\r\n','2016-01-15 10:10:00',1,1,'2016-01-15 17:13:18','您好，给您带来的不便非常抱歉，您可联系客服电话,祝您购物愉快！',1,1,'2016-01-15 17:16:13','您好，给您带来的不便非常抱歉，您可联系客服电话,祝您购物愉快！');
