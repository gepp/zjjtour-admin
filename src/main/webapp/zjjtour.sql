...
insert  into `bq_news`(`id`,`bq_id`,`news_id`) values (27,1063,58),(28,1063,48),(29,1063,47),(30,1064,47);
...
insert  into `news_maodian`(`id`,`news_id`,`orderlist`,`maodian_name`,`maodian_content`) values (24,59,1,'456','456'),(25,59,2,'789','789'),(42,58,1,'峰林奇观','																											<p>\r\n	这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述\r\n</p>\r\n<p>\r\n	<img src=\"/zjjtour-admin/attached/image/20160202/20160202212930_138.png\" alt=\"\" />\r\n</p>\r\n									\r\n									\r\n									'),(43,58,2,'风光美景','																		<p>\r\n	这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述\r\n</p>\r\n<p>\r\n	<img src=\"/zjjtour-admin/attached/image/20160202/20160202214209_226.jpg\" alt=\"\" />\r\n</p>\r\n									\r\n									'),(44,58,3,'交通路线','																											<p>\r\n	这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述\r\n</p>\r\n<p>\r\n	<img src=\"/zjjtour-admin/attached/image/20160202/20160202212945_640.jpg\" alt=\"\" />\r\n</p>\r\n									\r\n									\r\n									'),(45,58,4,'游览须知','																											<p>\r\n	这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述这里是文字描述\r\n</p>\r\n<p>\r\n	<img src=\"/zjjtour-admin/attached/image/20160202/20160202212958_855.png\" alt=\"\" />\r\n</p>\r\n									\r\n									\r\n									');
