			...
			<div id="tab1" class="tabson">
				<ul class="forminfo">
					<form action="" method="post" id="securityOrganizationForm">
						<li><label>机构名称<b></b></label> <input type="text"
						...
						<li><label>编码<b></b></label> <input type="text"
							...
							placeholder="请输入编码" /></li> <input type="hidden" class="dfinput" id="parentId" name="securityOrganization.parentId" placeholder="" />
						<li><label>上级机构编码<b></b></label> <input type="text"
							class="dfinput" id="parentName"
							name="parentName" placeholder=""  readonly  onclick="selectParentOrganization();" />
							<input type="button"  value="选择上级" onclick="selectParentOrganization();" class="btn"/>
						</li>
						<li><label>描述<b></b></label> <input type="text"
							class="dfinput" id="description"
							name="securityOrganization.description" placeholder="请输入描述" /></li>
