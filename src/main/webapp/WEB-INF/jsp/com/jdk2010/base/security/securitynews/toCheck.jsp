...
<body style="min-width: 300px">
		...
		<table class="tableEdit">
				<td>审核意见</td>
				<td>
				<textarea cols="60" rows="6" name="reviewReason" id="reviewReason" style="padding:5px">
		...
		<li><label>&nbsp;</label><input name="" type="button"
							class="btn" value=" 确定" onclick="check();"/> &nbsp;&nbsp; <input name=""
							type="button" class="btn" value="关闭"
							onclick="closeAll();" /></li>
</body>
</html>
<script type="text/javascript">
	...
	function check(){
		...
		$.ajax({
			url : "${ contextpath}/securitynews/updateStatus",
