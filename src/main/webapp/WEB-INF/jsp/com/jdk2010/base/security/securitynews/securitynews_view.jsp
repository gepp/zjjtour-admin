				...
				<ul class="forminfo">
					<form action="" method="post" id="securityNewsForm">
						<li><label>通告标题<b></b></label>
							<div class="control-group">${securityNews.title}</div></li>
						<li><label>通告内容<b></b></label>
							<div class="control-group">${securityNews.content}</div></li>
						 
						<li><label>是否启用<b></b></label>
							<div class="control-group">${securityNews.status=='1'?'启用':'停用'}</div></li>
						<li><label>创建时间<b></b></label>
							<div class="control-group">${ securityNews.ctime}</div></li>
