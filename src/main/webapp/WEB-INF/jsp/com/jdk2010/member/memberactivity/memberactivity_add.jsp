...
<body>
	...
	<div class="formbody">
		<div id="usual1" class="usual">
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">活动新增</a></li>
				</ul>
			</div>
					...
					<form action="" method="post" id="memberActivityForm">
					 ...
					 <li><label>缩略图<b></b></label> <input type="text"
						...
						<li><label>开始时间<b></b></label> <input type="text"
							...
							placeholder="请输入开始时间"  onfocus="WdatePicker({isShowWeek:true})"/></li>
						<li><label>截止时间<b></b></label>
						<input type="text"
							class="dfinput" id="endTime" name="memberActivity.endTime"
							placeholder="请输入截止时间" value="${ memberActivity.endTime}"  onfocus="WdatePicker({isShowWeek:true})"/></li>
