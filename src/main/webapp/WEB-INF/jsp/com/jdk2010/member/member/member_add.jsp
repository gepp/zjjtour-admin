...
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="post"  id="memberForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="member.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>会员名称<b></b></label>
 			   <input  type="text" class="dfinput" id="nickname" name="member.nickname" placeholder="请输入会员名称"  />
 			   </li>
 				       			 			   <li><label>邮箱<b></b></label>
 			   <input  type="text" class="dfinput" id="email" name="member.email" placeholder="请输入邮箱"  />
 			   </li>
 				       			 			   <li><label>手机<b></b></label>
 			   <input  type="text" class="dfinput" id="mobile" name="member.mobile" placeholder="请输入手机"  />
 			   </li>
 				       			 			   <li><label>真实姓名<b></b></label>
 			   <input  type="text" class="dfinput" id="realname" name="member.realname" placeholder="请输入真实姓名"  />
 			   </li>
 				       			 			   <li><label>性别<b></b></label>
 			   <input  type="text" class="dfinput" id="sex" name="member.sex" placeholder="请输入性别"  />
 			   </li>
 				       			 			   <li><label>启用标志<b></b></label>
 			   <input  type="text" class="dfinput" id="status" name="member.status" placeholder="请输入启用标志"  />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="ctime" name="member.ctime" placeholder="请输入创建时间"  />
 			   </li>
