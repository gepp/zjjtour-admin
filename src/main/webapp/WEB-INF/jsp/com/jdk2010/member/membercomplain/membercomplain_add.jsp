...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">会员投诉添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="post"  id="memberComplainForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="memberComplain.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>会员ID<b></b></label>
 			   <input  type="text" class="dfinput" id="memberId" name="memberComplain.memberId" placeholder="请输入会员ID"  />
 			   </li>
 				       			 			   <li><label>会员手机<b></b></label>
 			   <input  type="text" class="dfinput" id="memberMobile" name="memberComplain.memberMobile" placeholder="请输入会员手机"  />
 			   </li>
 				       			 			   <li><label>会员姓名<b></b></label>
 			   <input  type="text" class="dfinput" id="memberName" name="memberComplain.memberName" placeholder="请输入会员姓名"  />
 			   </li>
 				       			 			   <li><label>投诉内容<b></b></label>
 			   <input  type="text" class="dfinput" id="complainMessage" name="memberComplain.complainMessage" placeholder="请输入投诉内容"  />
 			   </li>
 				       			 			   <li><label>投诉时间<b></b></label>
 			   <input  type="text" class="dfinput" id="complainTime" name="memberComplain.complainTime" placeholder="请输入投诉时间"  />
 			   </li>
 				       			 			   <li><label>回复状态<b></b></label>
 			   <input  type="text" class="dfinput" id="replayStatus" name="memberComplain.replayStatus" placeholder="请输入回复状态"  />
 			   </li>
 				       			 			   <li><label>回复人id<b></b></label>
 			   <input  type="text" class="dfinput" id="replayUserid" name="memberComplain.replayUserid" placeholder="请输入回复人id"  />
 			   </li>
 				       			 			   <li><label>回复时间<b></b></label>
 			   <input  type="text" class="dfinput" id="replayTime" name="memberComplain.replayTime" placeholder="请输入回复时间"  />
 			   </li>
 				       			 			   <li><label>回复内容<b></b></label>
 			   <input  type="text" class="dfinput" id="replayMessage" name="memberComplain.replayMessage" placeholder="请输入回复内容"  />
 			   </li>
 				       			 			   <li><label>审核状态<b></b></label>
 			   <input  type="text" class="dfinput" id="reviewStatus" name="memberComplain.reviewStatus" placeholder="请输入审核状态"  />
 			   </li>
 				       			 			   <li><label>审核人id<b></b></label>
 			   <input  type="text" class="dfinput" id="reviewUserid" name="memberComplain.reviewUserid" placeholder="请输入审核人id"  />
 			   </li>
 				       			 			   <li><label>审核时间<b></b></label>
 			   <input  type="text" class="dfinput" id="reviewTime" name="memberComplain.reviewTime" placeholder="请输入审核时间"  />
 			   </li>
 				       			 			   <li><label>审核意见<b></b></label>
 			   <input  type="text" class="dfinput" id="reviewMessage" name="memberComplain.reviewMessage" placeholder="请输入审核意见"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/membercomplain/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
