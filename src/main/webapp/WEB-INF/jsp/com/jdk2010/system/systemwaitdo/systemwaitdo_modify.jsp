...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">代办事项编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="POST"  id="systemWaitdoForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="systemWaitdo.id" placeholder="请输入id" value="${ systemWaitdo.id}" />
 			   </li>
 				       			 			   <li><label>栏目名称<b></b></label>
 			   <input  type="text" class="dfinput" id="name" name="systemWaitdo.name" placeholder="请输入栏目名称" value="${ systemWaitdo.name}" />
 			   </li>
 				       			 			   <li><label>代办事项名称<b></b></label>
 			   <input  type="text" class="dfinput" id="title" name="systemWaitdo.title" placeholder="请输入代办事项名称" value="${ systemWaitdo.title}" />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="ctime" name="systemWaitdo.ctime" placeholder="请输入创建时间" value="${ systemWaitdo.ctime}" />
 			   </li>
 				       			 			   <li><label>状态<b></b></label>
 			   <input  type="text" class="dfinput" id="status" name="systemWaitdo.status" placeholder="请输入状态" value="${ systemWaitdo.status}" />
 			   </li>
 				       			 			   <li><label>user_id<b></b></label>
 			   <input  type="text" class="dfinput" id="userId" name="systemWaitdo.userId" placeholder="请输入user_id" value="${ systemWaitdo.userId}" />
 			   </li>
 				       			 			   <li><label>类型<b></b></label>
 			   <input  type="text" class="dfinput" id="type" name="systemWaitdo.type" placeholder="请输入类型" value="${ systemWaitdo.type}" />
 			   </li>
 				       			 			   <li><label>目标ID<b></b></label>
 			   <input  type="text" class="dfinput" id="targetId" name="systemWaitdo.targetId" placeholder="请输入目标ID" value="${ systemWaitdo.targetId}" />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url: "${ contextpath}/systemwaitdo/modifyaction",
 			            data: $(form).serialize(),
 			            type: "POST",
