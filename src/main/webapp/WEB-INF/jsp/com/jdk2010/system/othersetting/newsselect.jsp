...
<body style="min-width: 300px">
	...
	<div class="rightinfo">
	<form method="post" action="${ contextpath}/bqselect.htm">
		...
		<page:page href="${contextpath}/bqselect.htm?title=${title}&menuId=${menu.id }"
			data="pageList" />
		...
		function submitCheck(){
			...
			parent.layer.confirm('您确认添加您所选择的'+count+'条数据么？',function(index){
				...
				jQuery.ajax({
							...
							dataType: "json",
							data:{action:'delete',ids:del_ids,type:'1'},
